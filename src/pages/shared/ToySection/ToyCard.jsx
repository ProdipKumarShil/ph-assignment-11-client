...
const ToyCard = ({ toy }) => {
  ...
  return (
    <div className=" mt-2  relative ">
      <Link to='#' class="block p-4 h-full max-w-sm  bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700  ">
        <img src={img} className='h-48 text-center mx-auto' alt="flash sale" />
        <h5 class="mb-2 text-lg font-bold tracking-tight text-gray-900 dark:text-white">{name}</h5>
        ...
        <p class=" text-gray-400 dark:text-gray-400 text-xl font-semibold"><span className='text-secondary text-2xl'>${price}</span></p>
      </Link>
