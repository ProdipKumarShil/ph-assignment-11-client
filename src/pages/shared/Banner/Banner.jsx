  ...
  return (
    <div className='mx-auto max-w-screen-xl grid grid-cols-12 gap-3'>
      ...
      <div className="p-4 md:p-0 col-span-12 md:col-span-3 mt-2 relative">
        ...
        <Link to='#' className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 text-center">
          <img src={sale1} className='h-48 text-center mx-auto' alt="flash sale" />
          <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 ">Groot</h5>
          ...
          <p className=" text-gray-400  text-xl font-semibold"> <del>$50</del> <span className='text-secondary text-2xl'>$45</span></p>
          <kbd className="absolute top-[65px] right-9 px-2 py-1.5 text-xs font-semibold text-gray-800  bg-secondary border-gray-200 rounded-lg  ">-10%</kbd>
        </Link>
