...
const SingleToy = () => {
  const { name, img, price, rating } = useLoaderData()
  return (
    <div className="grid grid-cols-12 mx-auto max-w-screen-xl">
      ...
      <div className="flex w-full mt-4 ml-4 mr-4 col-span-9 flex-col items-center bg-white border  border-gray-200 rounded-lg shadow md:flex-row  ">
        ...
        <div className="flex flex-col justify-between p-4 leading-normal">
          ...
          <p className="mb-3 font-semibold text-gray-700 dark:text-gray-400">Price: ${price}</p>
        ...
        <div className="flex gap-2">
          <Link to={`/`} className="text-bg bg-primary rounded-full  font-medium  text-sm px-5 py-3 ">Home</Link>
          <Link className="text-bg  bg-primary rounded-full  font-medium  text-sm px-5 py-3 ">Add to cart</Link>
        </div>
