    ...
    <div className='mx-auto max-w-screen-xl grid grid-cols-1  md:grid-cols-2 items-center'>
      ...
      <div className="mx-4">
        <form className='' onSubmit={handleEmailLogin}>
          ...
          <button onClick={handleGoogleLogin} type="submit" class="text-bg bg-gray-200 mt-2 focus:outline-none cursor-pointer w-full px-5 py-2.5 text-center " ><img className='h-8 mx-auto' src={google} alt="" /></button>
      </div>
    </div>
  );
};
